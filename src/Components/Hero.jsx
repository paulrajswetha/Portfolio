    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 text-center">
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
          ...
          >
            <span className="text-xl md:text-2xl font-semibold text-blue-500 dark:text-blue-400 font-mono">
              {typed}
              <span className="inline-block w-0.5 h-6 bg-blue-500 ml-0.5 align-middle animate-pulse" />
            </span>
          </motion.div>
          ...
          <motion.p
            variants={itemVariants}
            className="text-base md:text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed mb-10"
          >
          ...
          >
            <motion.a
              ...
              className="px-7 py-3.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-full shadow-lg hover:shadow-blue-500/25 transition-all text-sm"
            ...
            <motion.a
              ...
              className="px-7 py-3.5 border-2 border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 font-semibold rounded-full hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-all text-sm"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.96 }}
            >
              Contact Me
